<div class="flex flex-col md:flex-row gap-4 md:justify-between">
     <div>
          <h1 class="text-xl font-semibold text-dark-900 dark:text-light-300">Welocme {{ Auth::user()->name }}</h1>
          <p class="text-dark-600 dark:text-light-500">Today : {{ date('l, d M Y') }}</p>
     </div>
     <x-form>
